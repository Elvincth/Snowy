...
class Note {
    ...
    static get style() { return ".sc-ion-note-ios-h{color:var(--color);font-family:var(--ion-font-family,inherit);--color:var(--ion-text-color-step-650, #a6a6a6)}.ion-color.sc-ion-note-ios-h{color:var(--ion-color-base)}"; }
    static get styleMode() { return "ios"; }
}
...
class SkeletonText {
    ...
    static get style() { return ".sc-ion-skeleton-text-ios-h{display:inline-block;width:100%;pointer-events:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;--background:var(--ion-text-color, #000)}span.sc-ion-skeleton-text-ios{display:inline-block;font-size:8px;background:var(--background);opacity:.1}"; }
    static get styleMode() { return "ios"; }
}
