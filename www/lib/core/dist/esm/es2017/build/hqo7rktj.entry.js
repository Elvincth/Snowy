...
class CardHeader {
    ...
    static get style() { return ":host{display:block;position:relative;padding:20px 20px 16px}:host(.card-header-translucent){background-color:rgba(var(--ion-background-color-rgb,255,255,255),.9);-webkit-backdrop-filter:saturate(180%) blur(30px);backdrop-filter:saturate(180%) blur(30px)}"; }
    static get styleMode() { return "ios"; }
}
...
class CardSubtitle {
    ...
    static get style() { return ":host{display:block;position:relative;color:var(--color);--color:var(--ion-text-color-step-400, #666666);margin:0 0 4px;padding:0;font-size:12px;font-weight:700;letter-spacing:.4px;text-transform:uppercase}:host(.ion-color){color:var(--ion-color-base)}"; }
    static get styleMode() { return "ios"; }
}
...
class CardTitle {
    ...
    static get style() { return ":host{display:block;position:relative;color:var(--color);--color:var(--ion-text-color, #000);margin:0;padding:0;font-size:28px;font-weight:700;line-height:1.2}:host(.ion-color){color:var(--ion-color-base)}"; }
    static get styleMode() { return "ios"; }
}
