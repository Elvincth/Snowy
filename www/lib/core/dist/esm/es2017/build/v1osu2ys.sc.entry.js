...
class CardHeader {
    ...
    static get style() { return ".sc-ion-card-header-md-h{display:block;position:relative;padding:16px}"; }
    static get styleMode() { return "md"; }
}
...
class CardSubtitle {
    ...
    static get style() { return ".sc-ion-card-subtitle-md-h{display:block;position:relative;color:var(--color);--color:var(--ion-text-color-step-450, #737373);margin:0 0 8px;padding:0;font-size:14px}.ion-color.sc-ion-card-subtitle-md-h{color:var(--ion-color-base)}"; }
    static get styleMode() { return "md"; }
}
...
class CardTitle {
    ...
    static get style() { return ".sc-ion-card-title-md-h{display:block;position:relative;color:var(--color);--color:var(--ion-text-color-step-150, #262626);margin:0;padding:0;font-size:24px;line-height:1.2}.ion-color.sc-ion-card-title-md-h{color:var(--ion-color-base)}"; }
    static get styleMode() { return "md"; }
}
