...
function treatAilments(env) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const ailments = yield Promise.all(exports.registry.ailments.map((ailment) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let detected = false;
            try {
                detected = yield ailment.detected(env);
            }
            catch (e) {
                env.log.debug(() => `Error while checking ${chalk_1.default.bold(ailment.id)}:\n\n${chalk_1.default.red(e.stack ? e.stack : e)}`);
            }
            count++;
        ...
        fn(`Detected ${chalk_1.default.bold(String(detectedAilments.length))} issue${detectedAilments.length === 1 ? '' : 's'}.${detectedAilments.length === 0 ? ' Aww yeah! 💪' : ''}`);
