...
class CardSubtitle {
    ...
    static get style() { return ".sc-ion-card-subtitle-ios-h{display:block;position:relative;color:var(--color);--color:var(--ion-text-color-step-400, #666666);margin:0 0 4px;padding:0;font-size:12px;font-weight:700;letter-spacing:.4px;text-transform:uppercase}.ion-color.sc-ion-card-subtitle-ios-h{color:var(--ion-color-base)}"; }
    static get styleMode() { return "ios"; }
}
...
class CardTitle {
    ...
    static get style() { return ".sc-ion-card-title-ios-h{display:block;position:relative;color:var(--color);--color:var(--ion-text-color, #000);margin:0;padding:0;font-size:28px;font-weight:700;line-height:1.2}.ion-color.sc-ion-card-title-ios-h{color:var(--ion-color-base)}"; }
    static get styleMode() { return "ios"; }
}
