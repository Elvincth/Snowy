...
class Reorder {
    ...
    static get style() { return "[slot].sc-ion-reorder-ios-h{display:none;line-height:0;z-index:100}.reorder-icon.sc-ion-reorder-ios{display:block;font-size:34px;opacity:.4}"; }
